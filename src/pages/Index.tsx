    ...
    <main>
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-display font-extrabold uppercase leading-[0.9] mb-6">
              Wear<br />The Void
            </h1>
            <p className="text-muted-foreground text-base md:text-lg mb-8 max-w-md leading-relaxed">
              Premium streetwear essentials. Designed for those who move differently.
            </p>
      ...
      <section className="container pb-20">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link to="/shop?badge=best-seller" className="text-sm uppercase tracking-wide text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1">
        ...
        <div className="container py-20">
          <div className="max-w-2xl mx-auto text-center mb-16">
            ...
            <p className="text-muted-foreground leading-relaxed">
              VOIDWEAR is born from the intersection of minimal design and street culture. Every piece is crafted with heavyweight materials, considered construction, and a relentless focus on quality over quantity.
            </p>
          </div>
        ...
        <div className="max-w-md mx-auto text-center">
          ...
          <form className="flex gap-2" onSubmit={e => e.preventDefault()}>
            <input
              ...
              className="flex-1 h-12 px-4 border border-border bg-background text-sm focus:outline-none focus:ring-1 focus:ring-foreground"
            />
            <Button type="submit" className="h-12 px-6 text-sm uppercase tracking-widest font-semibold">
              Join
            </Button>
          </form>
        </div>
